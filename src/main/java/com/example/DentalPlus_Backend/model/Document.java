...
@JsonPropertyOrder({ "id", "patient", "name", "storagePath", "mimeType", "documentType", "active", "notes" })
@Entity
@Table(name = "document")
public class Document {
	...
	public Document(Patient patient, String name, String storagePath, String mimeType, String documentType,
	...
	public static boolean isNameValid(String name) {
		return name != null && !name.isBlank() && name.trim().length() <= 150;
	}

	public static boolean isStoragePathValid(String storagePath) {
		return storagePath != null && !storagePath.isBlank() && storagePath.trim().length() <= 255;
	}

	public static boolean isMimeTypeValid(String mimeType) {
		return mimeType != null && !mimeType.isBlank() && mimeType.trim().length() <= 100;
	}
	...
	public static boolean isDocumentTypeValid(String documentType) {
		...
		return normalized.equals("CONSENT") || normalized.equals("XRAY") || normalized.equals("REPORT")
				|| normalized.equals("PRESCRIPTION") || normalized.equals("OTHER");
	}
