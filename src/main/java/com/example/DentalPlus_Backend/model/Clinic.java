...
@JsonPropertyOrder({ "id", "organization", "calendarRule", "name", "active", "country", "city", "address", "phone",
		"email", "timeZone", "notes" })
@Entity
@Table(name = "clinic")
public class Clinic {
	...
	public Clinic(Organization organization, CalendarRule calendarRule, String name, Boolean active, String country,
			String city, String address, String phone, String email, String timeZone, String notes) {
