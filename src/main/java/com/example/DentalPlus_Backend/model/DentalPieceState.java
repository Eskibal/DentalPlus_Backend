...
@JsonPropertyOrder({ "id", "dentalPiece", "stateType", "notes", "createdAt", "updatedAt", "active" })
@Entity
...
public class DentalPieceState {
	...
	public static boolean isStateTypeValid(String stateType) {
		...
		return normalized.equals("HEALTHY") || normalized.equals("NATURAL_ABSENCE")
				|| normalized.equals("EXTRACTION_PENDING") || normalized.equals("EXTRACTION_DONE")
				|| normalized.equals("CROWN_PENDING") || normalized.equals("CROWN_DONE")
				|| normalized.equals("ENDODONTICS_PENDING") || normalized.equals("ENDODONTICS_DONE")
				|| normalized.equals("BRIDGE_PENDING") || normalized.equals("BRIDGE_DONE")
