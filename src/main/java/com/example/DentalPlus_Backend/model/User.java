...
@JsonPropertyOrder({ "id", "username", "themePreference", "languagePreference", "active", "notes" })
@Entity
@Table(name = "user")
public class User {
	...
	public User(String username, String password, String themePreference, String languagePreference, Boolean active,
			String notes) {
	...
	public static boolean isUsernameValid(String username) {
		return username != null && !username.isBlank() && username.trim().length() <= MAX_USERNAME_LENGTH;
	}
	...
	public static boolean isLanguagePreferenceValid(String languagePreference) {
		return languagePreference == null || languagePreference.isBlank() || languagePreference.trim().length() <= 10;
	}
