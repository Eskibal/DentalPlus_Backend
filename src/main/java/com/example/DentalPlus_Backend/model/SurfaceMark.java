...
@Entity
@Table(name = "surface_mark")
public class SurfaceMark {
    ...
    public SurfaceMark(DentalSurface dentalSurface, String markType, String markState, String notes) {
    ...
    public static boolean isMarkTypeValid(String markType) {
        ...
        return normalized.equals("CARIES")
                || normalized.equals("FILLING")
                || normalized.equals("RADIOGRAPH_CARIES")
                || normalized.equals("FISSURE_SEALANT")
                || normalized.equals("EXTRACTION")
                || normalized.equals("CROWN")
                || normalized.equals("ENDODONTICS")
