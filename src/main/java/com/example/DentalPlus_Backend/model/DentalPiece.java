...
@JsonPropertyOrder({ "id", "odontogram", "pieceNumber", "pieceKind" })
@Entity
@Table(name = "dental_piece", uniqueConstraints = @UniqueConstraint(columnNames = { "odontogram_id", "piece_number" }))
