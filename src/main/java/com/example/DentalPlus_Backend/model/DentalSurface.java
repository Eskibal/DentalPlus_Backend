...
@JsonPropertyOrder({ "id", "dentalPiece", "surfaceType", "notes" })
@Entity
@Table(name = "dental_surface", uniqueConstraints = @UniqueConstraint(columnNames = { "dental_piece_id",
		"surface_type" }))
public class DentalSurface {
	...
	public static boolean isSurfaceTypeValid(String surfaceType) {
		...
		return normalized.equals("MESIAL") || normalized.equals("DISTAL") || normalized.equals("VESTIBULAR")
				|| normalized.equals("LINGUAL") || normalized.equals("OCCLUSAL");
	}
	...
	public static boolean isSurfaceTypeValidForPieceKind(String surfaceType, String pieceKind) {
		...
		if (normalizedPieceKind.equals("FRONT")) {
			return normalizedSurface.equals("MESIAL") || normalizedSurface.equals("DISTAL")
					|| normalizedSurface.equals("VESTIBULAR") || normalizedSurface.equals("LINGUAL");
		}
