...
public class SupabaseStorageService {
	...
	public String uploadPdf(MultipartFile file, String folder) throws IOException {
		...
		String endpoint = supabaseConfig.getUrl() + "/storage/v1/object/" + supabaseConfig.getDocumentsBucket() + "/"
				+ filePath;
	...
	public String getPublicUrl(String filePath) {
		...
		return supabaseConfig.getUrl() + "/storage/v1/object/public/" + supabaseConfig.getDocumentsBucket() + "/"
				+ filePath;
	}
	...
	private String buildFilePath(String folder, String originalFilename) {
		...
		String safeName = (originalFilename == null || originalFilename.isBlank()) ? "document.pdf"
